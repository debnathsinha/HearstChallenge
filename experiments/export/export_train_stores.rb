...
class ExportTrainStores
  ...
  def execute_query
    rs =  DB.find_by_sql("select #{@fields.join(',')} from store_mo")
  ...
  def load
    ...
    write_output_file(lines, "export_train_stores.dat")
  end
...
if __FILE__ == $0
  ...
  puts "Exporting train stores data."
  o = ExportTrainStores.new
  o.load  
  puts "done."
end