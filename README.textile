...
no sales (all zeros) gives an RMSE of 23.0487

h4. average sales (all stores/issues/years/months)

average of all sales is 9.9273 
gives an RMSE of 20.1289


h4. average of issue/year/month for all stores
...
h4. average of issue/year/month by store wholesaler 

there are 65 wholesalers in the sales_mo table and 40 in the sales_vd

are all vd wholesalers mo wholesalers?
no, two are not
...
how many stores does this effect
* 19 of 2456
...
how many distinct wholesaler/issue/year/month records are there for template_vd2
* there are 7802
* select count(*) from
...
we can select the average issue sales for wholesaler/issue/year/month and use the average issue/year/month for those that have no results
the query for the first part is

- re-created template tables to include wholesaler information to make the join easier
