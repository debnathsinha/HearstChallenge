...
The objective of the competition is to predict the monthly sales of magazine sales in each store. Submissions are assessed based on the RMSE of the submission.
...
file without the predictions (order is presumed important).
...
** template_for_submission.csv : 492,100 records of 4 attributes (store_key, title_key, year_month, sales_total). This is the submission
